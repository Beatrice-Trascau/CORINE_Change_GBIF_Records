...
# Define breaks for the cover legend - based on actual estimate range (not including error bars)
legend_breaks_cover <- c(max(cover_effect_no_year_interaction$Fill_Value, na.rm = TRUE),
                         1, 0, -1,
                         min(cover_effect_no_year_interaction$Fill_Value, na.rm = TRUE))
...
# Add label to plot a)
figure3a_models <- plot_grid(a, ncol = 1, labels = c("a)"))

# Save to file as .png
ggsave(here("figures", "Figure3a_update_model_outputs.png"),
...
# Add label to plot b)
figure3b_time <- plot_grid(time_updated, ncol = 1, labels = c("b)"))
...
# Save to file as .png
ggsave(here("figures", "Figure3_updated_models.png"),
       plot = cover_time_combined_plot,
       width = 20, height = 13, dpi = 300)

# Save to file as .svg
ggsave(here("figures", "Figure3_updated_models.svg"),
       plot = cover_time_combined_plot,
       width = 20, height = 13)
